...
<head>
  ...
  <link rel="stylesheet" href="./../../assets/css/buy/ingredientDetail.css">
  
  <script defer src="./../../assets/js/buy/ingredientDetail.js"></script>
  ...
  <title>밥세권 - 가게 재료목록</title>
  
</head>
<body>
  <header id="header"></header>
  <div id="heartMessage" class="heart-message"></div>
    ...
    <div class="wrap">
          ...
          <div id="buy_food_section">
            <div class="buy_food_menu_list">
              ...
              <div class="buy_each_container">
                <p class="buy_food_stock">재고 8개</p>
                <p class="buy_food_menu_name">레전드 당근</p>
                ...
                <div class="price_menu">가격 : 400원</div>
              </div>
            </div>

            <div class="buy_food_menu_list">
              <img src="./../../assets/img/sigumchee.jpg" alt="메뉴 이미지">
              <div class="buy_each_container">
                <p class="buy_food_stock">재고 3개</p>
                <p class="buy_food_menu_name">시금치 1단</p>
                <div class="buy_food_stock_choice">
                  <a href="#" class="minus">-</a>
                  <p class="count">1</p>
                  <a href="#" class="plus">+</a>
      ...
      <div class="buy_map_area">
        ...
        <div class="buy_origin">
          ...
          <!-- <div class="moving_page"><a href="./../buy/ingredientList.html">목록으로 이동</a></div> -->
        </div>
      </div>
    </div>
    </div>
