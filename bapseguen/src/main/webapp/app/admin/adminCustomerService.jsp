        ...
        <div class="admin_list_title">
          <ul class="admin_list">
            <a href="./../../app/admin/adminCustomerService.html">
              <li id="admin_list_menu_admincustomerservice" class="admin_list_menu">고객센터</li>
            </a>
            <a href="./../../app/admin/adminInquiry.html">
              <li id="admin_list_menu_admininquiry" class="admin_list_menu">문의목록</li>
            </a>
          </ul>
        </div>
        <div class="admin_list_whitebox">
          ...
          <ul class="admin_list_valuebox">
            <li class="admin_list_value">
              <p id="admin_list_num_value" class="admin_list_row">공지</p>
              <a href="./../../app/admin/noticeDetail.html" class="admin_list_userid_link"><p id="admin_list_title_value" class="admin_list_row">[FAQ] 문의는 어떻게 하나요?</p></a>
